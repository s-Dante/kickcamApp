    ...
    <div class="max-w-5xl mx-auto p-6">
        ...
        <div class="relative w-full  aspect-video border-4 border-black rounded-xl overflow-hidden shadow-lg">
            ...
            <a-scene
                embedded
                class="w-full h-full"
                mindar-image="imageTargetSrc: {{ asset('assets/targets-ar/shields.mind') }}; uiScanning:no; uiLoading:no; uiError:no; warmupTolerance:1; missTolerance:1;"
                color-space="sRGB"
                ...
                <a-assets>
                    <a-asset-item id="avatarModel" src="{{ asset('assets/3d-models/character-idle.glb') }}"></a-asset-item>
                ...
                <a-entity mindar-image-target="targetIndex: 0">
                    <a-gltf-model class="avatar_model" rotation="0 0 0 " position="0 -0.5 0" scale="0.8 0.8 0.8" src="#avatarModel" animation-mixer>
                    </a-gltf-model>
                </a-entity>
                <a-entity mindar-image-target="targetIndex: 1">
                    <a-gltf-model rotation="0 0 0 " position="0 -0.5 0" scale="0.8 0.8 0.8" src="#avatarModel" animation-mixer>
                    </a-gltf-model>
                </a-entity>
