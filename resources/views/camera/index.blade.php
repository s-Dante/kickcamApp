...
<x-general-layout title="KickCam Pro">
    ...
    <div class="text-center mb-6">
        <h1 class="text-2xl font-bold">KickCam Pro</h1>
        <p class="text-gray-500">Filtros AR en tiempo real</p>
    </div>

    <div id="container"
        class="relative w-full max-w-[640px] aspect-video rounded-xl overflow-hidden shadow-2xl mx-auto">
    </div>
    ...
    <div class="flex flex-col items-center mt-6">
        ...
        <select id="country"
            class="px-4 py-2 border-2 border-gray-300 rounded-lg shadow-sm focus:border-blue-500 w-[400px]">
