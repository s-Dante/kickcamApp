@php
    $classes = [
        ...
        'desktop' => [
            ...
            'logo_icon' => 'block h-8 w-auto fill-current text-secondary-sat',
            'logo_text' => 'text-secondary-sat font-bold text-xl tracking-tight hidden sm:block',
        ...
        'mobile_menu' => [
            'container' => 'hidden sm:hidden bg-primary border-t border-tertiary border-b absolute w-full shadow-lg',
            'inner' => 'pt-4 pb-1',
            'info_wrapper' => 'px-4',
        ...
        'mobile_bottom' => [
            'container' => 'sm:hidden fixed bottom-0 w-full bg-primary border-t border-tertiary xl:pb-safe z-50',
            'inner' => 'flex justify-around items-center h-16',
            'link' => 'flex flex-col items-center justify-center w-full h-full text-xs font-medium transition-colors',
            'link_active' => 'text-accent font-bold',
            'link_inactive' => 'text-tertiary-sat hover:text-secondary-desat',
            'icon_svg' => 'w-6 h-6 mb-1',
            'action_wrapper' => 'relative w-full flex justify-center mt-[-30px]',
            'action_btn' => 'flex flex-col items-center justify-center bg-accent-desat p-3 rounded-full shadow-lg border-4 border-primary text-accent-sat transition-transform hover:scale-105',
            'action_btn_active' => 'scale-110'
        ]
    ];
@endphp
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="{{ $classes['mobile_menu']['container'] }}">
        <div class="{{ $classes['mobile_menu']['inner'] }}">
            ...
            <div class="{{ $classes['mobile_menu']['links'] }}">
                <x-responsive-nav-link :href="route('profile.edit')" class="{{ $classes['mobile_menu']['link_text'] }}">
                    {{ __('Profile Settings') }}
...
<div class="{{ $classes['mobile_bottom']['container'] }}">
    <div class="{{ $classes['mobile_bottom']['inner'] }}">

        <a href="{{ route('dashboard') }}"
            class="{{ $classes['mobile_bottom']['link'] }} {{ request()->routeIs('dashboard') ? $classes['mobile_bottom']['link_active'] : $classes['mobile_bottom']['link_inactive'] }}">
            <svg class="{{ $classes['mobile_bottom']['icon_svg'] }}" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route('trivia.index') }}"
            class="{{ $classes['mobile_bottom']['link'] }} {{ request()->routeIs('trivia.*') ? $classes['mobile_bottom']['link_active'] : $classes['mobile_bottom']['link_inactive'] }}">
            <svg class="{{ $classes['mobile_bottom']['icon_svg'] }}" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="{{ $classes['mobile_bottom']['action_wrapper'] }}">
            <a href="{{ route('arCamera') }}"
                class="{{ $classes['mobile_bottom']['action_btn'] }} {{ request()->routeIs('arCamera') ? $classes['mobile_bottom']['action_btn_active'] : '' }}">
        ...
        <a href="{{ route('multimedia.index') }}"
            class="{{ $classes['mobile_bottom']['link'] }} {{ request()->routeIs('multimedia.*') ? $classes['mobile_bottom']['link_active'] : $classes['mobile_bottom']['link_inactive'] }}">
            <svg class="{{ $classes['mobile_bottom']['icon_svg'] }}" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route('scoreboard.index') }}"
            class="{{ $classes['mobile_bottom']['link'] }} {{ request()->routeIs('scoreboard.*') ? $classes['mobile_bottom']['link_active'] : $classes['mobile_bottom']['link_inactive'] }}">
            <svg class="{{ $classes['mobile_bottom']['icon_svg'] }}" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
