    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 px-4 sm:px-0">
                <h1 class="{{ $ui['h1'] }}">Centro de Trivia</h1>
                <p class="mt-1 {{ $ui['text-muted'] }}">Demuestra cuánto sabes sobre el mundo y sus selecciones.</p>
            </div>

            <!-- Global Challenge (Main Card) -->
            <div
                class="{{ $ui['card-accent'] }} mb-8 mx-4 sm:mx-0 transform transition-transform hover:scale-[1.01] cursor-pointer">
                <a href="{{ route('trivia.play', 'world') }}" class="block p-6 sm:p-10 relative">
                    ...
                    <div class="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-6">
                        <div class="text-center sm:text-left">
                            <span
                                class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-semibold bg-accent-desat text-accent-sat dark:bg-accent-sat dark:text-accent-desat mb-3 shadow-sm border border-accent/30">
                            ...
                            <h2
                                class="text-3xl sm:text-4xl font-extrabold text-secondary-sat dark:text-secondary-desat mb-2 drop-shadow-md">
                                Desafío
                                Mundial</h2>
                            <p
                                class="text-secondary dark:text-tertiary-desat text-sm sm:text-base max-w-xl mx-auto sm:mx-0">
                        ...
                        <div class="flex-shrink-0 relative">
                            <div
                                class="w-24 h-24 sm:w-32 sm:h-32 bg-primary/40 rounded-full flex items-center justify-center backdrop-blur-sm border border-tertiary shadow-2xl">
            ...
            <div class="px-4 sm:px-0">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="{{ $ui['h2'] }}">Trivias por País</h3>
                    <span
                        class="text-xs font-medium {{ $ui['text-muted'] }} bg-tertiary-desat px-2 py-1 rounded-full border border-tertiary">En
                        Base de Datos</span>
                </div>
