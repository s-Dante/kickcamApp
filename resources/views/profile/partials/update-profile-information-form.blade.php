    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <x-text-input id="father_lastname" name="father_lastname" type="text" class="mt-1 block w-full"
            ...
            <div>
                ...
                <x-text-input id="mother_lastname" name="mother_lastname" type="text" class="mt-1 block w-full"
